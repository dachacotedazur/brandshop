    ...
    >
      <Link href={`/product/${product.slug}`} className="product-card block group">
        ...
        <div className="p-3 lg:p-4">
          <h3 className="text-[#182162] text-[12px] lg:text-[13px] font-semibold leading-tight mb-1 tracking-tight line-clamp-2">
            {product.name}
          </h3>
          ...
          <div className="flex items-center justify-between">
            <div>
              <span className="text-[#182162] text-[13px] lg:text-[14px] font-bold tracking-tight">
            ...
            <button
              className="w-7 h-7 lg:w-8 lg:h-8 bg-[#182162] rounded-lg flex items-center justify-center
                         hover:bg-[#00C875] transition-colors"
              onClick={(e) => { e.preventDefault() }}
            >
              <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                <path d="M2 2h1.5l2 7h5.5l1.5-4H5.5" stroke="white" strokeWidth="1.2"
